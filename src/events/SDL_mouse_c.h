...
extern int SDL_SendPanEvent( SDL_Window * window, SDL_MouseID mouseID, Uint64 precise_x, Uint64 precise_y, Uint8 contains_x, Uint8 contains_y, Uint8 is_fling, Uint8 is_interrupt, SDL_MouseWheelSource source_type);
